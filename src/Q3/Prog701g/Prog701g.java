...
public class Prog701g {
    public static void main(String[] args) {
        try {
            ...
            double tot = 0; // for abg gpa
            int cnt = 0;
            int totstus = 0; // for teachers
            String large = "";
            String small = "lkjhgfdslkjhkjlkjhgfdgfddrfgfhslkflkjhbfdhewsajrgfhlfkdjglkajekfjsalkjglajefajs;lkgnalwjkdsjaf;lkaweghjewarkanrwajrsaufoiskjfhsagkjeafkjskjfhakjfhkjglkjahkjfjaeoijfhkjajfoidsalkjfaeokjgfhnkdnglkesajhlkjesalkewslkglksjf;lksaj;lkfjalkgj;lkesafnlkdnvkjsalkfj;";
            ...
            System.out.println("Total number of student staught by teachers: " + totstus);
